...
import { checkBackendHealth, HealthResponse, API_BASE_URL, getCurrentUser, UserProfile, getStoredToken } from "../lib/api";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-canvas text-white flex flex-col font-sans">
      <Navbar user={user} />

      <main className="flex-1 max-w-5xl w-full mx-auto p-6 md:p-12 flex flex-col justify-between">
        {/* Header Bar */}
